...
pdf(file.path('graphs', 'lambda_rmse.pdf'))
empty <- plyr::empty
...
pdf(file.path('graphs', 'ideal_point_predictions.pdf'))
empty <- plyr::empty
...
rm(empty)
dev.off()
pdf(file.path('graphs', 'ideal_point_residuals.pdf'))
empty <- plyr::empty
...
pdf(file.path('graphs', 'test_set_performance.pdf'))
empty <- plyr::empty
...
write.csv(data.frame(Term = names(most.democratic.terms),
          ...
          file.path('cache', 'most_democratic_terms.csv'),
          row.names = FALSE)
...
write.csv(data.frame(Term = names(most.republican.terms),
          ...
          file.path('cache', 'most_republican_terms.csv'),
          row.names = FALSE)
...
pdf(file.path('graphs', 'estimated_coefficients.pdf'))
